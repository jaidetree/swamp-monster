defmodule SwampWeb.Layouts do
  ...
  def app(assigns) do
      ...
      <div class="container navbar">
        <div class="flex-1">
          <a href="/" class="flex-1 flex w-fit items-center gap-2 text-2xl text-white/75 hover:text-white transition-color duration-300">
            <span class="font-logo">Swamp Monster Leather</span>
          </a>
        </div>
        <div class="flex-none">
    ...
    <footer class="bg-black py-4 text-xs">
      <div class="container">
        &copy; Copyright 2026 by Swamp Monster Leather
      </div>
    </footer>
